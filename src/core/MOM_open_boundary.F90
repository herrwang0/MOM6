  ...
  do n=1, OBC%number_of_segments
    ...
    if (associated(segment%tr_Reg)) then
      if (segment%is_E_or_W) then ! EW segment
        ...
        do m=1, OBC%ntr
          if (allocated(segment%tr_Reg%Tr(m)%tres) .and. allocated(OBC%tres_x)) then ; do k=1,GV%ke ; do j=js,je
        ...
        do m=1, OBC%ntr
          if (allocated(segment%tr_Reg%Tr(m)%tres) .and. allocated(OBC%tres_y)) then ; do k=1,GV%ke ; do i=is,ie
