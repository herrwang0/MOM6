...
public initialize_OBC_thickness_reservoirs
...
!> Initialize thickness reservoirs to the current external thickness value.
subroutine initialize_OBC_thickness_reservoirs(GV, OBC)
  type(verticalGrid_type), intent(in) :: GV  !< Ocean vertical grid structure
  type(ocean_OBC_type),    pointer    :: OBC !< Open boundary structure
  ...
  if (.not. associated(OBC)) return
  if (.not. (OBC%thickness_x_reservoirs_used .or. OBC%thickness_y_reservoirs_used)) return
  ...
  enddo ! end segment loop
end subroutine initialize_OBC_thickness_reservoirs

!> Initialize tracer reservoirs to the current external tracer value.
subroutine initialize_OBC_tracer_reservoirs(GV, OBC)
  type(verticalGrid_type), intent(in) :: GV  !< Ocean vertical grid structure
  type(ocean_OBC_type),    pointer    :: OBC !< Open boundary structure
