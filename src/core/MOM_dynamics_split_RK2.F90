...
subroutine step_MOM_dyn_split_RK2(u, v, h, dz, tv, visc, Time_local, dt, forces, p_surf_begin, p_surf_end, &
...
subroutine initialize_dyn_split_RK2(u, v, h, dz, uh, vh, eta, Time, G, GV, US, param_file, &
